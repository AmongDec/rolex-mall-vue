...
<div class="entire">
    ...
    <div class="content">
        ...
        <div class="content_right">
            ...
            <!-- 2. 购买的商品信息 -->
            <div  class="content_right-shopMsg">
                <!--左-->
                <div class="content_right-shopMsg_left">
                    <img width="205px" height="205px"  :src="'../../../static/img/good/'+goodlist.g1.goodTable.gid+'/'+goodlist.g1.goodTable.gmainPic"/>
                </div>
                <!--中:这里的样式是我直接copy过来的，所以class的名称我没有改-->
                <div class="content_left-bottom_msg">
                    <div class="content_left-bottom_msg-up">
                        <!-- 腕表名称 -->
                        <span class="content_left-bottom_msg-up_name" >{{goodlist.g1.goodTable.gname}}</span> <br/>
                        <span>型号：</span>
                        <span class="content_left-bottom_msg-up_design">{{goodlist.g1.goodTable.gversion}}</span> <br/>
                        <span>材质：</span>
                        <span class="content_left-bottom_msg-up_design">{{goodlist.g1.goodTable.gmaterial}}</span>
                    </div>
                ...
                <div class="content_right-shopMsg_right">
                    ...
                    <span class="content_right-shopMsg_right-monny">
								原价￥
								<span >{{number_format(goodlist.g1.goodTable.gprice, 2, '.', ',')}}</span>
							</span>
                </div>
                <!--空盒子-->
                <div class="clear"></div>
            ...
            <div  class="content_right-shopMsg">
                <!--左-->
                <div class="content_right-shopMsg_left">
                    <img width="205px" height="205px"  :src="'../../../static/img/good/'+goodlist.g2.goodTable.gid+'/'+goodlist.g2.goodTable.gmainPic"/>
                </div>
                <!--中:这里的样式是我直接copy过来的，所以class的名称我没有改-->
                <div class="content_left-bottom_msg">
                    <div class="content_left-bottom_msg-up">
                        <!-- 腕表名称 -->
                        <span class="content_left-bottom_msg-up_name" >{{goodlist.g2.goodTable.gname}}</span> <br/>
                        <span>型号：</span>
                        <span class="content_left-bottom_msg-up_design">{{goodlist.g2.goodTable.gversion}}</span> <br/>
                        <span>材质：</span>
                        <span class="content_left-bottom_msg-up_design">{{goodlist.g2.goodTable.gmaterial}}</span>
                    </div>
                    <div class="content_left-bottom_msg-mid">
                        <span class="content_left-bottom_msg-up_name2"></span>有货 <br/>
                    </div>
                ...
                <div class="content_right-shopMsg_right">
                    ...
                    <span class="content_right-shopMsg_right-monny">
								原价￥
								<span >{{number_format(goodlist.g2.goodTable.gprice, 2, '.', ',')}}</span>
							</span>
                </div>
                <!--空盒子-->
                <div class="clear"></div>
            ...
            <div class="content_right-amount">
                <div class="content_right-amount_shopAmount">
                    商品原价
                    <span>￥{{number_format(goodlist.srcprice, 2, '.', ',')}}</span>
                </div>
                ...
                <div class="content_right-amount_superAmount">
                    ...
                    <span class="sign">
								￥
								<span >{{number_format(goodlist.desprice, 2, '.', ',')}}</span>
							</span>
                </div>
            </div>
            <!-- 4. 提交订单 -->
...
export default {
  ...
  data(){
    return {
      yinsi: false,
      goodlist: this.$qs.parse(this.$route.query.orderkun),
  ...
  methods:{
    ...
    async createorder(){
      ...
      const list = this.goodlist
      const sub = {
        oneorder: {
          uid: window.sessionStorage.getItem('token'),
          addid: adds,
          ototalprice: list.desprice
        },
        goodlist: list
      }
      console.log(sub)
      ...
      //发送创建订单的网络请求
      try{
        let res = await this.$http.post('order/createkun',sub)
